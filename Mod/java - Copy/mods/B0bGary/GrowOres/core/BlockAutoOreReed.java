...
{
	public TileEntityAutoReed t2= new TileEntityAutoReed();
	public String mat2="";
    ...
    public void updateTick(World world, int x, int y, int z, Random rand)
    {
    	...
    	TileEntityAutoReed t = (TileEntityAutoReed) world.getTileEntity(x, y, z);
    	if (t != null)
    	{
